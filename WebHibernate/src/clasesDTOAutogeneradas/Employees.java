...
public class Employees implements java.io.Serializable {
	...
	{
		return "</br><font size = 5<b><u> Empleados: </b></u></font>" + "</br></br>"  + "<font size = 2><b><u>EMPLEADO_ID: </b></u>" + employeeId + "</br></br>" + "<b><u>NOMBRE: </b></u>"
				+ firstName + "</br></br>"  + "<b><u>APELLIDO: </b></u>" + lastName + "</br></br>"  + "<b><u>EMAIL: </b></u>" + email + "</br></br>" 
				+ "<b><u>TELEFONO: </b></u>" + phoneNumber + "</br></br>" + "<b><u>FECHA ALTA: </b></u>" + hireDate + "</br></br>" 
				+ "<b><u>SALARIO: </b></u>" + salary + "</br></br>" 
				 + "</br></br>" + "</br></br></br></br>" 
				+ "</font>";	
	}
