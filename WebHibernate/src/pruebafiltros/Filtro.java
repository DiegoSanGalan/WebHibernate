...
public class Filtro implements Filter {
	...
	public void destroy() {
		...
		log.trace("Ha pasado por método **destroy** de la clase **Filtro**");
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1,
		...
		log.trace("Ha pasado por método **doFilter** de la clase **Filtro**");
		...
		log.info("El tiempo que tarda HIBERNATE es :" + (timeFin - timeInicio));
		
		ServletContext sc = arg0.getServletContext();
		Integer i = (Integer) sc.getAttribute("peticiones");
		i++;
		sc.setAttribute("peticiones", i);
		log.info("El filtro HIBERNATE se ha llamado: " + i + " veces.");
	...
	public void init(FilterConfig arg0) throws ServletException {
		// TODO Auto-generated method stub
		log.trace("Ha pasado por método **init** de la clase **Filtro**");
